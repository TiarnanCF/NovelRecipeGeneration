...
A note about MATLAB compatibility
    ...
    (2011). They are not necessarily compatible with older/newer versions of MATLAB.

    For newer versions of MATLAB, if you receive a "variable not declared error" it
    may be due to a change in the variable scope between parent + nested functions.
    In this case, setting the variable equal to zero before the nested function call
...
23 March 2021 - v1.3 - Fix to generateEdges.m for newer version of MATLAB


---------------------------------------------------------------------------
Copyright (C) 2013-2021 Christopher Aicher
